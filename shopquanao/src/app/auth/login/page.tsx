    ...
    return (
        <div>
            ...
            <div className="py-20 px-4 sm:px-20 lg:px-44 flex flex-col lg:flex-row w-full gap-8 sm:gap-20 bg-gray-100 items-center justify-center">
                <FormLogin />
                <FormSection 
                    className="p-8 bg-white shadow-lg rounded-lg flex flex-1" 
                    inputsSection={inputsSection} 
                    title="Register here if you are a new customer." 
                    grow="flex-1" 
                    titleMain="Create an Account" 
                    titleButton="Submit & Register"
                />
            </div>
