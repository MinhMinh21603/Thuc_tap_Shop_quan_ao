    ...
    <div className="w-full max-w-md p-8 bg-white rounded-md shadow-md">
      ...
      <form>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <a href="#" className="text-pink-500">Forgot Your Password?</a>
        </div>
        <button type="submit" className="w-full bg-pink-500 text-white py-2 rounded-md">Login</button>
      </form>
      <div className="mt-4">
        <button className="w-full bg-blue-500 text-white py-2 rounded-md mb-2">Login with Facebook</button>
        <button className="w-full bg-red-500 text-white py-2 rounded-md mb-2">Login with Google</button>
        <button className="w-full bg-blue-400 text-white py-2 rounded-md">Login with Twitter</button>
      </div>
      <p className="mt-4">Don't Have an Account? <a href="#" className="text-pink-500">Sign up now</a></p>
    </div>
  );
};
  ...
  return (
    <div className="w-full max-w-md p-8 bg-white rounded-md shadow-md">
      ...
      <form>
        ...
        <button type="submit" className="w-full bg-pink-500 text-white py-2 rounded-md">Submit & Register</button>
      </form>
    </div>
  );
};
